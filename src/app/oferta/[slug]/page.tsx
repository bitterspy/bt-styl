            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {okno.kolory.map((kolor) => (
                  <span
                    key={kolor}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-gray-50 border border-gray-200 text-gray-700"
                  >
                    <CheckCircle2 size={12} style={{ color: '#c0392b' }} />
                    {kolor}
                  </span>
                ))}
              </div>
